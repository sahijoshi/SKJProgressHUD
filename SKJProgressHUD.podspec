...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of SKJProgressHUD.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/sahik.joshi@gmail.com/SKJProgressHUD'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'sahik.joshi@gmail.com' => 'sahik.joshi@gmail.com' }
  s.source           = { :git => 'https://github.com/sahik.joshi@gmail.com/SKJProgressHUD.git', :tag => s.version.to_s }
